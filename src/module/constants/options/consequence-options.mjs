...
export const consequenceOptions = {
  rolls: {
    ...
    heal: "TERIOCK.EFFECTS.RollableEffects.heal.deal",
    revitalize: "TERIOCK.EFFECTS.RollableEffects.revitalize.deal",
  ...
  takes: {
    ...
    heal: "TERIOCK.EFFECTS.RollableEffects.heal.take",
    revitalize: "TERIOCK.EFFECTS.RollableEffects.revitalize.take",
  ...
  common: {
    ...
    heal: "TERIOCK.EFFECTS.Common.heal",
    revitalize: "TERIOCK.EFFECTS.Common.revitalize",
