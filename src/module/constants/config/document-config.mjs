...
export default {
  ability: /** @type {Teriock.Config.DocumentEntry} */ {
    ...
    importDialog: selectAbilityDialog,
    index: "abilities",
  ...
  body: /** @type {Teriock.Config.DocumentEntry} */ {
    ...
    importDialog: selectBodyPartDialog,
    index: "bodyParts",
  ...
  creature: /** @type {Teriock.Config.DocumentEntry} */ {
    ...
    icon: icons.manifest.document.creature,
  ...
  effect: /** @type {Teriock.Config.DocumentEntry} */ {
    documentName: "ActiveEffect",
    getter: "effects",
    icon: icons.manifest.document.effect,
  ...
  equipment: /** @type {Teriock.Config.DocumentEntry} */ {
    ...
    importDialog: selectEquipmentTypeDialog,
    index: "equipment",
  ...
  mount: /** @type {Teriock.Config.DocumentEntry} */ {
    ...
    icon: icons.manifest.document.mount,
  ...
  property: /** @type {Teriock.Config.DocumentEntry} */ {
    ...
    importDialog: selectPropertyDialog,
    index: "properties",
  ...
  species: /** @type {Teriock.Config.DocumentEntry} */ {
    ...
    importDialog: selectSpeciesDialog,
    index: "creatures",
  ...
  stone: /** @type {Teriock.Config.DocumentEntry} */ {
    ...
    icon: icons.manifest.document.stone,
