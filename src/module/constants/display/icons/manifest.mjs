export default {
  ...
  activation: { placeRegion: "mdi-checkerboard-plus" },
  ...
  movement: {
    ...
    crawl: "mdi-snail",
    difficultTerrain: "ms-landscape",
    dig: "mdi-shovel",
    dive: "ms-scuba-diving",
    fly: "mdi-feather",
    hidden: "ms-domino-mask",
    leapHorizontal: "ms-sprint",
    leapVertical: "ms-sports-handball",
    swim: "ms-pool",
  ...
  sense: {
    ...
    dark: "ms-bedtime",
    ethereal: "mdi-ghost",
    hearing: "mdi-sine-wave",
    invisible: "ms-undereye",
    sight: "ms-visibility",
    smell: "mdi-scent",
    truth: "ms-eye-tracking",
  },
  settings: {
    alternateRules: "ms-alt-route",
  ...
  ui: {
    ...
    options: "ms-tune",
    panel: "ms-toolbar",
    permissions: "ms-manage-accounts",
    qualifier: "ms-mystery",
    quantity: "ms-tag",
    remove: "ms-close",
    reset: "ms-replay",
    save: "ms-save",
    secret: "ms-disabled-visible",
    ...
    show: "ms-visibility",
    sort: "ms-sort",
    suppression: "ms-hide-source",
    system: "ms-rule-settings",
