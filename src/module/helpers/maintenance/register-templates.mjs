...
export default async function registerTemplates() {
  return foundry.applications.handlebars.loadTemplates([
    ...
    "systems/teriock/src/templates/document-templates/effect-templates/ability-template/parts/impact-section.hbs",
    ...
    "systems/teriock/src/templates/document-templates/shared/impact-macros.hbs",
