...
export function _prepareDerivedData(abilityData) {
  ...
  if (applyChanges) {
    if (abilityData.applies.base.changes.length > 0) {
      abilityData.parent.changes =
        /** @type {EffectChangeData[]} */ abilityData.applies.base.changes;
    }
    if (
      ...
      abilityData.parent.changes =
        /** @type {EffectChangeData[]} */ abilityData.applies.proficient.changes;
    }
    if (
      ...
      abilityData.parent.changes =
        /** @type {EffectChangeData[]} */ abilityData.applies.fluent.changes;
    }
  }
