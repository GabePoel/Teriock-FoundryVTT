...
export default function ArmamentSystemMixin(Base) {
  ...
  class ArmamentSystem extends mixClasses(Base, AttackSystemMixin) {
    ...
    get _displayButtons() {
      ...
      if ((formulaExists(this.damage.base) || formulaExists(this.damage.twoHanded)) && !formulaExists(this.hitBonus)) {
        buttons.push({
          button: "hit",
    ...
    prepareBaseData() {
      ...
      if (this.kind === "magic") { this.damage.types.add("magic"); }
