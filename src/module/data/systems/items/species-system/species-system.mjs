  ...
  )
{
  ...
  get color() {
    if (this.isTransformation) {
      if (this.transformationEffect.system.transformation.level === "minor") return TERIOCK.display.colors.palette.blue;
      if (this.transformationEffect.system.transformation.level === "full") return TERIOCK.display.colors.palette.green;
