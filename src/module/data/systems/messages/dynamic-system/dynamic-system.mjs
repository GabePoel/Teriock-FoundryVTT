...
/**
 * Dynamic chat message data model.
 * @extends {BaseMessageSystem}
 * @extends {Teriock.Models.DynamicMessageSystemData}
 * @extends {Teriock.Data.DynamicMessageData}
 * @mixes ActivatableSystem
 */
export default class DynamicMessageSystem extends mixClasses(BaseMessageSystem, systemMixins.ActivatableSystemMixin) {
  /** @inheritDoc */
  ...
  /** @inheritDoc */
  static get metadata() {
    return foundry.utils.mergeObject(super.metadata, { type: "dynamic" });
  }
