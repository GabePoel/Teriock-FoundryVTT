...
export default function SelectionPseudoDocumentMixin(Base) {
   ...
   * @property {boolean} expandFolders
   * @property {boolean} expandTables
   * @property {Set<TypedIdentifier>} globalIdentifiers
   * @property {Set<UUID>} globalUuids
   * @property {Set<TypedIdentifier>} localIdentifiers
   * @property {Teriock.System.FormulaString} localQualifier
   * @property {Set<UUID>} localUuids
   * @property {boolean} makeSeparateActivations
   * @property {boolean} multi
   * @property {boolean} selectInExecution
   */
