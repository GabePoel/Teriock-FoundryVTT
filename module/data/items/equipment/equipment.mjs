...
import {
  ...
  _undampen,
  _unequip,
} from "../../../data/items/equipment/_handling.mjs";
import {
  _identify,
  _readMagic,
  _unidentify,
} from "../../../data/items/equipment/_identifying.mjs";
...
export class TeriockEquipmentData extends MixinWikiData(MixinConsumableData(TeriockItemData)) {
  static defineSchema() {
