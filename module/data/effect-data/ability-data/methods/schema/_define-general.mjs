...
export function _defineGeneral(schema) {
    return {
        ...
        elderSorcery: new fields.BooleanField({
            initial: false, label: "Elder Sorcery",
        }),
        elderSorceryIncant: new fields.HTMLField({initial: ""}),
        powerSources: new fields.ArrayField(/** @type {typeof StringField} */
            new fields.StringField({
                choices: abilityOptions.powerSources,
            }),),
        interaction: new fields.StringField({
            initial: "attack", choices: abilityOptions.interaction,
        }),
        featSaveAttribute: new fields.StringField({
            initial: "mov", choices: abilityOptions.featSaveAttribute,
        }),
        maneuver: new fields.StringField({
            initial: "active", choices: abilityOptions.maneuver,
        }),
        executionTime: new fields.StringField({initial: "a1"}),
        delivery: new fields.SchemaField({
            base: new fields.StringField({
                initial: "weapon", choices: abilityOptions.delivery,
            }), parent: new fields.StringField({
                initial: null, nullable: true, choices: abilityOptions.deliveryParent,
            }), package: new fields.StringField({
                initial: null, nullable: true, choices: abilityOptions.deliveryPackage,
            }),
        }),
        targets: new fields.ArrayField(/** @type {typeof StringField} */
            new fields.StringField({
                choices: abilityOptions.targets,
            })),
        elements: new fields.ArrayField(/** @type {typeof StringField} */
            new fields.StringField({
        ...
        duration: new fields.SchemaField({
            ...
            conditions: new fields.SchemaField({
                present: new fields.SetField(/** @type {StringField} */
                ...
                absent: new fields.SetField(/** @type {StringField} */
                    new fields.StringField({choices: conditions}), {
        ...
        costs: new fields.SchemaField({
            ...
            }), break: new fields.StringField({initial: ""}), materialCost: new fields.HTMLField({initial: ""}),
        }),
        ...
        effects: new fields.ArrayField(/** @type {typeof StringField} */
            new fields.StringField({
        ...
        prepared: new fields.BooleanField({
            initial: true, label: "Prepared",
        }),
        warded: new fields.BooleanField({
            initial: false, label: "Warded",
        }),
        secret: new fields.BooleanField({
            initial: false, label: "Secret",
        }),
    };
}
