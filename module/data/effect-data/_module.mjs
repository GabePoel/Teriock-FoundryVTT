...
export { default as AttunementData } from "./attunement-data/attunement-data.mjs";
...
export { default as PropertyData } from "./property-data/property-data.mjs";
export { default as ResourceData } from "./resource-data/resource-data.mjs";
