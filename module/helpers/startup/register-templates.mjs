...
export default async function registerTemplates() {
  return foundry.applications.handlebars.loadTemplates([
    ...
    "systems/teriock/templates/sheets/character-template/results/ch-power-results.hbs",
    "systems/teriock/templates/sheets/character-template/results/ch-rank-results.hbs",
    "systems/teriock/templates/sheets/character-template/results/ch-resource-results.hbs",
    ...
    "systems/teriock/templates/sheets/character-template/tabs/ch-tab-protections.hbs",
