...
export const TeriockAbilityMixin = (Base) =>
  class TeriockAbilityMixin extends Base {
  ...
  async _prepareContext() {
    ...
    context.childAbilities = this.document.system.children.contents;
    context.parent = this.document.getParent();
    const editors = {
